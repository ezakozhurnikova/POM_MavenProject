...
public class PracticeFormPage extends BasePage {
    ...
    private void selectOS() {
        String os = System.getProperty("os.name");// opr OS
...
WebElement submitForm;
    ...
    public PracticeFormPage assertSubmittingForm(String message) {
        Assert.assertTrue(submitForm.getText().contains(message));
        return this;
    }
}
